...
export class GlobalConstants {
  public static spells: Map<number, string> = new Map([
    [21, 'SummonerBarrier'],
    [1, 'SummonerBoost'],
    [14, 'SummonerDot'],
    [3, 'SummonerExhaust'],
  ...
  public static champions: Map<number, ChampionDetails> = new Map([
    ...
    [360, { id: 'Samira', name: 'Samira' }],
    [113, { id: 'Sejuani', name: 'Sejuani' }],
    [235, { id: 'Senna', name: 'Senna' }],
    [147, { id: 'Seraphine', name: 'Seraphine' }],
    [875, { id: 'Sett', name: 'Sett' }],
